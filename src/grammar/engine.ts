...
import { verbImperativeForms } from './verb'
...
function detectVerbPerson(tokenNorm: string, v: VerbLike, lemmaNorm: string, type?: InflectionType): SentencePerson {
  ...
  const matchesOverride = (s?: string) => Boolean(s?.trim()) && tokenNorm === normalizeToken(stripGreekTonos(s ?? ''))
  if (matchesOverride(o?.v_1sg)) return '1sg'
  if (matchesOverride(o?.v_2sg)) return '2sg'
  if (matchesOverride(o?.v_3sg)) return '3sg'
  if (matchesOverride(o?.v_1pl)) return '1pl'
  if (matchesOverride(o?.v_2pl)) return '2pl'
  if (matchesOverride(o?.v_3pl)) return '3pl'
  if (matchesOverride(o?.v_past_1sg)) return '1sg'
  if (matchesOverride(o?.v_past_2sg)) return '2sg'
  if (matchesOverride(o?.v_past_3sg)) return '3sg'
  if (matchesOverride(o?.v_past_1pl)) return '1pl'
  if (matchesOverride(o?.v_past_2pl)) return '2pl'
  if (matchesOverride(o?.v_past_3pl)) return '3pl'
  if (matchesOverride(o?.v_fut_1sg)) return '1sg'
  if (matchesOverride(o?.v_fut_2sg)) return '2sg'
  if (matchesOverride(o?.v_fut_3sg)) return '3sg'
  if (matchesOverride(o?.v_fut_1pl)) return '1pl'
  if (matchesOverride(o?.v_fut_2pl)) return '2pl'
  if (matchesOverride(o?.v_fut_3pl)) return '3pl'
  if (matchesOverride(o?.v_na_1sg)) return '1sg'
  if (matchesOverride(o?.v_na_2sg)) return '2sg'
  if (matchesOverride(o?.v_na_3sg)) return '3sg'
  if (matchesOverride(o?.v_na_1pl)) return '1pl'
  if (matchesOverride(o?.v_na_2pl)) return '2pl'
  if (matchesOverride(o?.v_na_3pl)) return '3pl'
  if (matchesOverride(o?.v_aor_past_1sg)) return '1sg'
  if (matchesOverride(o?.v_aor_past_2sg)) return '2sg'
  if (matchesOverride(o?.v_aor_past_3sg)) return '3sg'
  if (matchesOverride(o?.v_aor_past_1pl)) return '1pl'
  if (matchesOverride(o?.v_aor_past_2pl)) return '2pl'
  if (matchesOverride(o?.v_aor_past_3pl)) return '3pl'
  if (matchesOverride(o?.v_aor_fut_1sg)) return '1sg'
  if (matchesOverride(o?.v_aor_fut_2sg)) return '2sg'
  if (matchesOverride(o?.v_aor_fut_3sg)) return '3sg'
  if (matchesOverride(o?.v_aor_fut_1pl)) return '1pl'
  if (matchesOverride(o?.v_aor_fut_2pl)) return '2pl'
  if (matchesOverride(o?.v_aor_fut_3pl)) return '3pl'
  if (matchesOverride(o?.v_aor_na_1sg)) return '1sg'
  if (matchesOverride(o?.v_aor_na_2sg)) return '2sg'
  if (matchesOverride(o?.v_aor_na_3sg)) return '3sg'
  if (matchesOverride(o?.v_aor_na_1pl)) return '1pl'
  if (matchesOverride(o?.v_aor_na_2pl)) return '2pl'
  if (matchesOverride(o?.v_aor_na_3pl)) return '3pl'
  if (matchesOverride(o?.v_imp_2sg)) return '2sg'
  if (matchesOverride(o?.v_imp_2pl)) return '2pl'
  if (matchesOverride(o?.v_aor_imp_2sg)) return '2sg'
  if (matchesOverride(o?.v_aor_imp_2pl)) return '2pl'

  const impForms = verbImperativeForms(lemmaNorm, type)
  if (impForms) {
    if (matchesOverride(impForms.pres2sg) || matchesOverride(impForms.aor2sg)) return '2sg'
    if (matchesOverride(impForms.pres2pl) || matchesOverride(impForms.aor2pl)) return '2pl'
  }
